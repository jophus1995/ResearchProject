...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
  <div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
    ...
    <div class="row">
      <div class="col-sm-3">  <img src='../inc/JenniferPolack.jpg' class='img-fluid'> </div>
      <div class="col-sm-9">  <h4> Dr. Jennifer Polack </h4> <p>Email: jenniferpolack<!-- >@. -->&#64<!-- >@. -->gmail<!-- >@. -->.<!-- >@. -->com <br>Website: jenpolack.com  <br> Research Interests: Computer Science Education, Game Programming, Software Development, Interdisciplinary Research, Graphics </p>
      </div>
    </div>
    <div class="row">
    <div class="col-sm-12"> <p>  Recent Publications: <br> Jennifer A. Polack, Mary Clark, and John Evan May. 2016. Simulating restaurant traffic using Wi-Fi data (WIP). In Proceedings of the Summer Computer Simulation Conference (SCSC '16). Society for Computer Simulation International, San Diego, CA, USA, Article 9, six pages <br> Karen Anewalt and Jennifer Polack. 2017. A Curriculum Model Featuring Oral Communication Instruction and Practice. In Proceedings of the 2017 ACM SIGCSE Technical Symposium on Computer Science Education (SIGCSE '17). ACM, New York, NY, USA, 33-37. DOI:https://doi.org/10.1145/3017680.3017775 </p> </div>
    </div>
    <div class = "row"> </div>
  </div>
</div>
