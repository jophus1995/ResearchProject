...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
  <div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
    ...
    <div class="row">
      <div class="col-sm-3">  <img src='../inc/jzeitz.jpg' class='img-fluid'> </div>
      <div class="col-sm-9">  <h4> Dr. Jessica Zeitz </h4> <p>Email: jzeitz<!-- >@. -->&#64<!-- >@. -->umw<!-- >@. -->.<!-- >@. -->edu <br> Research Interests: Human-Computer Interaction, Information Visualization, Diversity in CS <br></p></div>
    </div>
    <div class="row">
      <div class="col-sm-12"> <p> Recent Publications: <br>Jessica Zeitz and Karen Anewalt. 2019. Assignments to promote diversity and accessibility. Journal of Computing Sciences in Colleges. 34, 3 (January 2019), 18-19 <br> Zeitz Self, J., Dowling, M., Wenskovitch, J., Crandell, I., Wang, M., House, L., Leman, S., North, C. “Observation- Level and Parameteric Interaction for High-Dimensional Data Analysis.” ACM Transactions on Interactive Intelligent Systems (TiiS) Special Issue Journal on Human-Centered Machine Learning, vol. 8, no. 2, July 2018. </p> </div>
    </div>
    <div class = "row"> </div>
  </div>
</div>
