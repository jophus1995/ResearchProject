...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
  <div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
    ...
    <div class="row">
      <div class="col-sm-3">  <img src='../inc/IanFinlayson.jpg' class='img-fluid'> </div>
      <div class="col-sm-9">  <h4> Dr. Ian Finlayson  </h4> <p>Email: ifinlay<!-- >@. -->&#64<!-- >@. -->umw<!-- >@. -->.<!-- >@. -->edu <br>Website: ianfinlayson.net  <br> Research Interests: Compilers, Computer Architecture, Programming Languages, Parallel Processing, Computer Science Education </p> </div>
    </div>
    <div class = "row"> </div>
  </div>
</div>
