...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
  <div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
    ...
    <div class="row">
      <div class="col-sm-3">  <img src='../inc/KarenAnewalt.jpg' class='img-fluid'> </div>
      <div class="col-sm-9">  <h4> Dr. Karen Anewalt </h4> <p>Email: anewalt<!-- >@. -->&#64<!-- >@. -->umw<!-- >@. -->.<!-- >@. -->edu <br> Research Interests: Computer Science Education, Diversity, Software Engineering, Networks<br></p></div>
    </div>
    <div class="row">
      <div class="col-sm-12"> <p> Recent Publications: <br>Jessica Zeitz and Karen Anewalt. 2019. Assignments to promote diversity and accessibility. Journal of Computing Sciences in Colleges. 34, 3 (January 2019), 18-19 <br> Karen Anewalt and Jennifer Polack. 2017. A Curriculum Model Featuring Oral Communication Instruction and Practice. In Proceedings of the 2017 ACM SIGCSE Technical Symposium on Computer Science Education (SIGCSE '17). ACM, New York, NY, USA, 33-37. DOI: https://doi-org.umw.idm.oclc.org/10.1145/3017680.3017775 </p> </div>
    </div>
    <div class = "row"> </div>
  </div>
</div>
