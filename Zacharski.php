...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
  <div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
    ...
    <div class="row">
      <div class="col-sm-3">  <img src='../inc/RZacharski.jpg' class='img-fluid'> </div>
      <div class="col-sm-9">  <h4> Dr. Ron Zacharski </h4> <p>Email: ron.zacharski<!-- >@. -->&#64<!-- >@. -->gmail<!-- >@. -->.<!-- >@. -->com <br> Research Interests: <br></p></div>
    </div>
    <div class="row">
      <div class="col-sm-12"> <p> Recent Publications: <br></p> </div>
    </div>
    <div class = "row"> </div>
  </div>
</div>
