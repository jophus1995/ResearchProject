<head>
  ...
  <!-- Website Page Title -->
  <title> Submission Successful Congrats Retard! </title>
</head>
...
<div class="jumbotron main"> <!-- jumbotron acts like a big screen, and anything inside of it is fit to its dimensions -->
	<div class="container-fluid"> <!-- normally this would watch screen-width, but since it's in a jumbotron, it only matches jumbotron width -->
		<div class="row">
			...
			<div class="col-sm-12"><center><h1>Submission Created</h1></center></div>
		</div>

		<div class="row">
			<!-- Email Verification Message -->
			<div class="col-sm-12"><p><center>Congradulations Submission Successful.</center></p></div>
		</div>
